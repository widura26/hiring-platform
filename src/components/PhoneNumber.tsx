...
import { ChevronsDown, ChevronsDownIcon, ChevronsUp, ChevronsUpDown } from "lucide-react";
    ...
    <div className="flex flex-col w-full">
      ...
      <div className="flex items-center border rounded-lg overflow-hidden">
        ...
        <Input
          ...
          className="rounded-none p-0 flex-1 shadow-none border-0 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:outline-none"
          value={phone}
